...
<body>
    ...
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          ...
          <h2 class="d-inline text-light">WEBSITE BAPENDA SITUBONDO</h2>
        </a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="{{$url=='destination'?'menu-active':''}}"><a href="{{url('destination')}}">Aplikasi</a></li>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright 2022<strong> Bapenda Situbondo </strong>. All Rights Reserved
      </div>
      <!-- <div class="credits">
